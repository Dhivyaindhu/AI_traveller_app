...
gemini_API_KEY = os.getenv("AIzaSyCBxouxQ_5gN9ikG_RK9a6WNUotzglMVmE")  # Ensure API key is set in the environment
    ...
    if st.button("Estimate Cost"):
        if source and destination:
            try:
                ...
                formatted_prompt = chat_template.format(source=source, destination=destination)
